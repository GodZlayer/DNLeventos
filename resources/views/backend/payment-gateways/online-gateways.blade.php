          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                <p class="text-warning">Success URL : {{ url('/') }}/event-booking/bank-notify </p>
                <p class="text-warning">Cancel URL : {{ url('/') }}/midtrans/cancel </p>
                <p class="text-warning">
                  <strong></strong>Set url form here : <a href="https://prnt.sc/OiucUCeYJIXo"
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                <p class="text-warning"><strong>Cron Job Command :</strong> curl -sS {{ url('/') }}/check-payment
                </p>
                <p class="text-danger">If you don't set cron job then the Iyzico payment method will not be work</p>
              </div>
            </div>
          </div>
