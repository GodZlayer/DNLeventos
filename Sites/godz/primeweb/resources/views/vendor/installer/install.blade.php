...
<head>
    ...
    <title>Installation - {{ config('app.name', 'Prime Web') }}</title>
    ...
    <div class="w-full bg-white shadow sm:rounded-lg">
        <div class="px-4 py-8 border-b border-gray-200 sm:px-6">
            <div class="flex justify-center items-center">
                ...
                <h2 class="pl-6 uppercase font-medium text-2xl text-gray-800">{{ config('app.name', 'Prime Web') }} Installation | NULLED <a style="color:red;" href="https://nullcave.pro/" target="_blank">NULLCAVE</a></h2>
            </div>
        </div>
